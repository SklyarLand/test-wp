...
var mobileFilter = function mobileFilter() {
    ...
    var pageFilterForm = pageFilter.querySelector('form');
    ...
    pageFilterForm.addEventListener('submit', function (event) {
        ...
        $.ajax({
            ...
            success: function (request) {
                let container = document.querySelector('.page-loop.with-filter');
