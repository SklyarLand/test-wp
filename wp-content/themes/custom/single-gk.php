...
<div class="container">
    ...
    <div class="page-top">
        ...
        <nav class="page-breadcrumb" itemprop="breadcrumb">
            ...
            <a href="/new-buildings">Новостройки</a><span class="breadcrumb-separator"> > </span>
        ...
        <div class="page-content">
            ...
            <article class="post">
                ...
                <div class="post-header">
                    ...
                    <h1 class="page-title-h1"><?php echo $post->post_title; ?></h1>
                    ...
                    <div class="post-header__details">
                        ...
                        <div class="metro"><span class="icon-metro icon-metro--green"></span>Сокол
                            <span>25 мин.<span
                ...
                <div class="post-image">
                    <?php echo get_the_post_thumbnail( $post->id, 'full', ['alt' => $post->post_title]); ?>
                ...
                <div class="post-text">
                    <p>
                        ...
                        района — улицы Кирова. В нескольких метрах от новостройки находится остановка общественного
                        транспорта
